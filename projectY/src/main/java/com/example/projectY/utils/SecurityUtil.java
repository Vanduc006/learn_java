package com.example.projectY.utils;
...
public class SecurityUtil {
    ...
    @Value("${projectY.jwt.access-token-validity-in-seconds}")
    ...
    public String createAccessToken(String email, ResLoginDTO.UserLoginDTO userLoginDTO) {
        ...
        JwsHeader jwsHeader = JwsHeader.with(this.JWT_ALGORITHM).build();
        return this.jwtEncoder.encode(JwtEncoderParameters.from(jwsHeader, claims)).getTokenValue();
    }

    public String createRefreshToken(String email, ResLoginDTO responeLoginDTO) {
        Instant now = Instant.now();
